...
export const listSteps: (_: any) => StepProps<EditFormProps>[] = (
  history: History
) => [
    {
      ...
      status: ({ child }) => doesChildIdFormHaveErrors(child) ? 'incomplete' : 'complete',
      EditComponent: () => (
        <Button
          appearance="unstyled"
          text={
    ...
    },
    {
      key: 'child-info',
      name: 'Child info',
      status: ({ child }) => doesChildInfoFormHaveErrors(child) ? 'incomplete' : 'complete',
      EditComponent: () => (
        <Button
          appearance="unstyled"
          text={
    ...
    },
    {
      key: 'family-address',
      name: 'Family address',
      status: ({ child }) => doesFamilyAddressFormHaveErrors(child?.family) ? 'incomplete' : 'complete',
      EditComponent: () => (
        <Button
          appearance="unstyled"
          text={
    ...
    },
    {
      ...
      status: ({ child }) => doesFamilyIncomeFormHaveErrors(child?.family) ? 'incomplete' : 'complete',
      EditComponent: () => (
        <Button
          appearance="unstyled"
          text={
    ...
    },
    {
      ...
      status: ({ child }) => doesEnrollmentFormHaveErrors(child) ? 'incomplete' : 'complete',
      EditComponent: () => (
        <Button
          appearance="unstyled"
          text={
