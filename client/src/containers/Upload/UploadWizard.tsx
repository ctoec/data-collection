      ...
      <div>
        ...
        {currentStepIndex === 0 && (
          <p>
            ...
            &nbsp;to enter all of the required state-funded enrollment data.
            When you’re finished, you can upload the complete template below.
            After your data is in the system, you can also{' '}
            <Link to="/roster">
