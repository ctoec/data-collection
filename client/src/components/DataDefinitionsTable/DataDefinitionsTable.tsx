...
const getSectionCopy = (section: string) => {
  ...
  if (section === TEMPLATE_SECTIONS.FAMILY_INCOME)
    return 'This data is collected to assess eligibility for public funding by calculating state median income percentage. Income determinations must be updated at least once a year. For the January 1 to May 31 data collection: If a child has had multiple income determinations, you only need to enter the most recent determination.';
