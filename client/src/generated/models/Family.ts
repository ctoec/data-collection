...
export function FamilyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Family {
    ...
    return {
        ...
        'determinations': !exists(json, 'determinations') ? undefined : ((json['determinations'] as Array<any>).map(FamilyDeterminationFromJSON)),
...
export function FamilyToJSON(value?: Family | null): any {
    ...
    return {
        ...
        'determinations': value.determinations === undefined ? undefined : ((value.determinations as Array<any>).map(FamilyDeterminationToJSON)),
