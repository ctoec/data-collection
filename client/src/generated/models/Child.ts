...
export function ChildFromJSONTyped(json: any, ignoreDiscriminator: boolean): Child {
    ...
    return {
        ...
        'c4KFamilyCaseNumber': !exists(json, 'c4KFamilyCaseNumber') ? undefined : json['c4KFamilyCaseNumber'],
        'c4KCertificates': !exists(json, 'c4KCertificates') ? undefined : ((json['c4KCertificates'] as Array<any>).map(C4KCertificateFromJSON)),
...
export function ChildToJSON(value?: Child | null): any {
    ...
    return {
        ...
        'c4KCertificates': value.c4KCertificates === undefined ? undefined : ((value.c4KCertificates as Array<any>).map(C4KCertificateToJSON)),
