...
export function OrganizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Organization {
    ...
    return {
        ...
        'fundingSpaces': !exists(json, 'fundingSpaces') ? undefined : ((json['fundingSpaces'] as Array<any>).map(FundingSpaceFromJSON)),
    };
}
...
export function OrganizationToJSON(value?: Organization | null): any {
    ...
    return {
        ...
        'fundingSpaces': value.fundingSpaces === undefined ? undefined : ((value.fundingSpaces as Array<any>).map(FundingSpaceToJSON)),
    };
}
