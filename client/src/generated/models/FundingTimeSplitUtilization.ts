...
export function FundingTimeSplitUtilizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): FundingTimeSplitUtilization {
    ...
    return {
        ...
        'fundingSpace': !exists(json, 'fundingSpace') ? undefined : FundingSpaceFromJSON(json['fundingSpace']),
