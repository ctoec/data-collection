...
const models: TsoaRoute.Models = {
  ...
  FlattenedEnrollment: {
    ...
    properties: {
      ...
      americanIndianOrAlaskaNative: { dataType: 'string' },
      asian: { dataType: 'string' },
      blackOrAfricanAmerican: { dataType: 'string' },
      nativeHawaiianOrPacificIslander: { dataType: 'string' },
      white: { dataType: 'string' },
      ethnicity: { dataType: 'string' },
      gender: { dataType: 'string' },
      dualLanguageLearner: { dataType: 'boolean' },
